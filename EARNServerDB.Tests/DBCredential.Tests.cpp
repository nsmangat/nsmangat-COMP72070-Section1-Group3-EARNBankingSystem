...
namespace DBCredentialTests
{
	...
	*	DBCredential_S000_F000_TZ	=	
	*
	*	"001 series" = only calls 0 series, operators, copy constructors
	*	DBCredential_S001_F000_TZ	=	
	*
	*	"002 series" = calls levels 0 - 1
	*	DBCredential_S002_F000_TZ	=	
	*/

	TEST_CLASS(DBCredential_S000_F000_TZ)
	{
	public:
	...
	TEST_CLASS(DBCredential_S001_F000_TZ)
	{
	public:
	...
	TEST_CLASS(DBCredential_S002_F000_TZ)
	{
	public:
